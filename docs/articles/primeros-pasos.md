...
> 🇬🇧 *This page is also available in English: [Getting
...
- **`praatpicture`** (de Rasmus Puggaard-Rode,
  <https://github.com/rpuggaardrode/praatpicture>): habilita la
  subpestaña *Praatpicture* (figuras multipanel al estilo Praat).
